...
//		
//		
//		ENN enn = new ENN(testSet, trainingSet, 1, null, null, 0.25);
//		long startTime = System.nanoTime();
//		enn.buildModel();
//		long endTime = System.nanoTime();
//		long duration = (endTime - startTime) * 1/1000000;
//		System.out.printf("%n%n%nTook %d milliseconds to build ENN model%n", duration);
//		for (int i = 0; i < testSet.size(); i++) {
//			enn.classify(testSet.get(i));
//		}	
//	}
//
//}
